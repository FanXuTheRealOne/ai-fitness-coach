...
// 原生 SVG 图标（从原 RN 版的 react-native-svg 1:1 转换为 DOM svg）。

export const CameraIcon = ({ size = 22, color = "#0c0c0c" }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill={color}>
    <path d="M12 15.2a3.2 3.2 0 1 0 0-6.4 3.2 3.2 0 0 0 0 6.4zM9 2L7.17 4H4a2 2 0 0 0-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2h-3.17L15 2H9z" />
  </svg>
);
...
export const WifiIcon = () => (
  <svg width={16} height={12} viewBox="0 0 16 12" fill="none">
    ...
    <path d="M1.5 4.5C3.5 2.5 5.6 1.5 8 1.5s4.5 1 6.5 3" stroke="white" strokeWidth={1.5} strokeLinecap="round" opacity={0.35} />
  </svg>
);
